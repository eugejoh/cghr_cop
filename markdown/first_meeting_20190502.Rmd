...
???
So you might ask, we call it a CoP or creat one?
...
???
You can generally break up a data workflow into separate catagories
...
???
The authours recognized this as time is a precious commodity, and this article they wrote touches on the bare-minimum requirements to conduct scienfitic analysis well. I recommend reading this article!
...
---
class: middle, title-slide, animate, fadeIn, faster
![](https://media.giphy.com/media/3s39mJ7zXU94mfAq4W/giphy.gif)
...
So following the "good enough" princples, we should be documenting these 5 things listed below.
...
???
so we accomplished all the processing in separate steps or lines of code. `dplyr` contains a pipe operator that allows to chain muliple functions together and make it really easy to write and read the code that does all the processing!
